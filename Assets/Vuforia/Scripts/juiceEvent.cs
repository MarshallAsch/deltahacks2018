...
public class juiceEvent : MonoBehaviour, ITrackableEventHandler {
	...
	void Start () {
		...
		if (GameObject.Find ("juiceText") != null)
		{
			tText = GameObject.Find ("juiceText").GetComponent<TextMeshPro> ();
		}
	...
	{
		string getCountriesUrl = "http://api.hermes.marshallasch.ca/v1/objects/juiceText";
