...
public class cibc : MonoBehaviour, ITrackableEventHandler {
	...
	void Start () {
		...
		if (GameObject.Find ("cibcText") != null)
		{
			tText = GameObject.Find ("cibcText").GetComponent<TextMeshPro> ();
		}
	}
	...
	{
		string getCountriesUrl = "http://api.hermes.marshallasch.ca/v1/objects/cibc";
